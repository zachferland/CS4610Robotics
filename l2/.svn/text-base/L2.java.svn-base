...
*/
public class L2 {
    public static final Double GOAL_THESHOLD = 50.0;
    ...
    * CONSTRUCTOR
    */
    public L2(OHMMDrive ohmm, Double goalX, Double goalY) throws Line.NoSuchLineException{
        this.ohmm = ohmm;
        this.goalX = goalX;
        this.goalY = goalY;
    ...
    public Boolean run() {
        ...
        if (!this.hasReachedGoal()) {
            ...
            this.moveUntilFrontSensorCovered();
            this.moveUntilMLine();
            this.ohmm.driveStraight((float)50);
            return this.moveUntilGoalOrBump();

            // if closer than at hit point
                // if goal between location and start
                    // goal unreachable
                // else goal is beyond current position
                    // face goal
                    // move until reach goal
            // else
                // goal unreachable
        }
        else
    ...
    */
    ...
    void moveUntilMLine() {
        ...
        while(!this.mLine.isOnLine((double)pose[0], (double)pose[1], 15.0));
    ...
    */
    public void faceGoal() {
        ...
        do {
            ...
            if (currentTheta < 0.0) currentTheta += 2.0 * Math.PI;
    ...
    public static void main(String[] argv) throws IOException {
        ...
        //Run algorithm
        L2 bugAlgo = new L2(ohmm, goalX, goalY);
        bugAlgo.run();
